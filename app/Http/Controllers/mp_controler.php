    ...
    function insert(request $request)
    {
        ...
        if($admin_phone){
            ...
            request()->validate([
                ...
                'mp_name.required' => 'অনুগ্রহ করে নাম লিখুন',
                // 'mp_phone.required' => 'অনুগ্রহ করে ফোন নাম্বার লিখুন',
                // 'mp_nid.required' => 'অনুগ্রহ করে এ আইডি নাম্বার লিখুন',
                // 'mp_email.required' => 'অনুগ্রহ করে ই-মেইল লিখুন',
                // 'mp_dob.required' => 'অনুগ্রহ করে জন্ম তারিখ লিখুন',
                // 'mp_img.required' => 'অনুগ্রহ করে ক',
