...
Route::get('/ps_ajax/{id}', [w_controler::class,'ajax']);
Route::get('/w_ajax/{p_id}/{ps_id}', [u_controler::class,'ajax']);
Route::get('/u_ajax/{p_id}/{ps_id}/{w_id}', [unit_rp_controler::class,'ajax']);
...
Route::post('/filter-unit', [SMSController::class,'unit_filter'])->name('unit.filter');


Route::get('/sms_history', [SMSController::class,'history'])->name('sms.history');

//test
Route::get('/test_sms', [SMSController::class,'test'])->name('sms.test');
