...
<body>
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin6">
                    ...
                    <ul class="navbar-nav float-start me-auto">
                        ...
                        <li class="nav-item search-box">
                            <a class="nav-link waves-effect waves-dark" href="{{url("/dasboard")}}">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" >
                        @if(Session::get('admin_phone'))
                            @if(Session::get('admin_phone')=='albddcn' || Session::get('admin_phone')=='jewel' )
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{url('/gallery')}}"
                                aria-expanded="false">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{ route('sms.history') }}"
                                aria-expanded="false">
                                <i class="me-2 mdi mdi-message-reply-text"></i>
                                <span class="hide-menu"> সকল বার্তার তালিকা </span>
                            </a>
                        </li>

                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" target="_blank" href="{{url('https://www.facebook.com/')}}"
                                aria-expanded="false">
                                <i class="me-2 mdi mdi-facebook"></i>
                                <span class="hide-menu">ফেসবুক</span>
                            </a>
                        </li>
                       ...
                       @else
                        ...
                        {{-- <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{url('/show_gallery')}}"
                                aria-expanded="false">
                                <i class="bi bi-plus-circle-fill"></i>
                                <span class="hide-menu">গ্যালারি</span>
                            </a>
                        </li> --}}
    ...
    <script>
        $(document).ready(function(){
            if(document.getElementById("custom_table") == null){
                $('#datatable').dataTable();
                console.log('good');
            }
        });
